    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center py-8 px-4">
        <div className="text-center mb-6">
          ...
          >
            Calculate your interest-only repayments and see how they compare to principal and interest loans
          </p>
        </div>
        ...
        <div className="w-full max-w-[1800px] flex justify-center px-6">
          <iframe 
            ...
            src="https://www.visionabacus.net/Tools/B3/SuiteA/Z200/MFAA/Interest_Only_Mortgage_Calculator/BlueGrey" 
            frameBorder="0" 
            scrolling="no"
            style={{ width: '100%', minHeight: '900px' }}
            title="Interest Only Repayment Calculator"
            data-testid="iframe-interest-only-calculator"
          />
        </div>
      </div>
